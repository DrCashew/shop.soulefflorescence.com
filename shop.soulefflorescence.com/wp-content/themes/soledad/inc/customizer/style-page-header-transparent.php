...
if ( ! function_exists( 'pencidesign_customizer_css_page_header_transparent' ) ):
	function pencidesign_customizer_css_page_header_transparent() {
		...
		<?php if ( $main_bar_close_color ): ?>
			...
			.penci-header-trans #navigation.sticky:not(.sticky-active) .show-search #searchform input.search-input::-webkit-input-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans #navigation.sticky:not(.sticky-active) .show-search #searchform input.search-input:-moz-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1;}
			.penci-header-trans #navigation.sticky:not(.sticky-active) .show-search #searchform input.search-input::-moz-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1;}
			.penci-header-trans #navigation.sticky:not(.sticky-active) .show-search #searchform input.search-input:-ms-input-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			...
			.penci-header-trans #navigation.sticky:not(.sticky-active) .show-search #searchform input.search-input{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
